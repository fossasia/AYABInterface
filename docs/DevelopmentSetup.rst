...
<https://github.com/AllYarnsAreBeautiful/AYABInterface/blob/master/docs/make_html.bat>`__ file in the
...
<https://travis-ci.org/AllYarnsAreBeautiful/AYABInterface/builds>`__.
...
5. Wait for `travis-ci <https://travis-ci.org/AllYarnsAreBeautiful/AYABInterface>`__ to pass the tests.
